...
\begin{document}
	...
	\textbf{Concealment} represents how suspicious the safe house is.
		...
		When actively trying to pass the location off as something else,
			the Subject gains a +5 per Concealment above 0 to relevant tests.\par
	...
	\begin{exampleblock}
			...
			Feel free to offer your Voices additional options beyond the ones given.
	\end{exampleblock}
...
%	\begin{multicols}{2}
	...
	\baseasset{Forge}{Enables Forge crafting. Depending on size and cost, this is a garage, smithy or industrial forge.}{1 / 2 / 4}{-2}{-2}{120 / 1,600 / 13,800}
	\baseasset{Lab}{Enables Chemical crafting. Depending on size and cost, this is a kitchen, brewery or industrial lab.}{1 / 2 / 4}{-2}{-2}{120 / 1,600 / 13,800}
	...
	\baseasset{Hidden Pathways}{Allows circling around or escaping from the aggressor in defense situations.}{0}{0}{+1}{320}
	...
	\baseasset{MedEvac / ER}{If during a mission a Subject is mortally wounded, he may be extracted and survive the encounter. He will however be traumatized and gain a Bane worth roughly 4 GP.}{4}{-3}{+1}{4,600}
