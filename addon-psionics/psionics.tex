...
\newcommand{\ul}{\underline{\smash{#1}}}[1]
...
%		*TODO: meme names*
	...
	\supply{Psi Core}{core melee component}{Immediately after hitting an opponent in melee, the wielder may cast a psionic power with a casting time of 1 action and range touch as a free action instead.}{cr 57}{0,4 kg}
	...
	\section{Chemicals}
	\subsubsection{Providence} %TODO: no longer necessary
	Type:\tab tablet/pill\\
	...
	\subsection{Sedative}
	\subsubsection{Superbia} %TODO: no longer necessary
	Type:\tab tablet/pill\\
