...
\begin{exampleblock}
	...
	\tt
	\small
	Urgent Discovery – Anomalous Phenomena in Real Space
	\par%
	Dear Dr. Moriko,
	\par%
	I hope this message reaches you securely.
	My team has uncovered something beyond explanation
		— beyond even the wildest hypotheses of quantum anomalies or neural simulation errors.
	\\%
	During a routine spatial flux analysis near the central data hub,
		my team detected irregular distortions
		— pulses of energy that defy all known principles of physics.
	At first, I thought it was interference from the city grid or a malfunction in our equipment,
	but the patterns... they seemed intentional.
	\par%
	When we probed further, the distortions responded
		— almost as if aware of our intrusion.
	\\%
	And then, the hallucinations began.
	Voices that don’t belong to any source,
		whispers threading through our augmented channels,
		words in languages I’ve never heard yet somehow understood.
	My lead engineer collapsed, mumbling about "the edge unraveling."
	\par%
	This is no glitch, no simple fluctuation.
	It feels alive - it IS alive!
	A presence seeping through reality’s fabric like ink bleeding through paper.
	Something other is reaching into our world, and I fear we’ve opened a door we can’t close.
	\par%
	I cannot believe what I’ve seen, Moriko.
	This goes beyond the bounds of science, beyond rationality itself.
	It's as though the universe itself has bent to accommodate something... alien, something impossible.
	Every instinct tells me this shouldn’t exist, and yet, there it is,
		defying reason at every turn.
	I don’t know if I’m losing my mind, but I need someone else to see this.
	\\%
	Please come.
	\par%
	Stay sharp,
...
\columnbreak
\tryincludewithfade[width=\columnwidth]{../art/\subtitle/anomalies/book-of-skin.png}
\end{multicols}
...
\\%
By the Adjudicator's discretion reflective surfaces in the area may show visions of possible futures.
\subsection*{Scaleway}
\paragraph{Description}
...
\paragraph{Heralds}
Two minds with an strong emotional bond (e.g. friends or rivals) pass out
...
\paragraph{Effects}
The two minds meld their emotions.
