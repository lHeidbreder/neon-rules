...
\subsubsection*{Rites}
The ritual leader makes repeated Courage-based Occultism tests
...
At the end the leader makes the Occultism test.
\subsubsection*{Effects}
...
\\%
The Occultism test is at a penalty depending on the type of request.
