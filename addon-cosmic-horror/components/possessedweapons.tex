...
Once the object is ready, the ritual leader must win a contest of wills
	(an opposed Courage-based Occultism test)
...
\begin{exampleblock}
	\itshape
	Ideally the Voices know only the meaning of each tarot card
...
\subsection{Traits}
\label{sec:traits}
\luaimport{components/weapontraits.json}{arcanum.tpl}{possessedweapontraits}
...
\begin{center}
	\tryincludewithfade[width=0.4\columnwidth]{../art/Cosmic Horrors/demon-sword.png}
\end{center}
