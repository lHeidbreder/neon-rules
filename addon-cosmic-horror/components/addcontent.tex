...
\vspace{8mm}
\begin{multicols}{2}
\boon{Blessed Birth}{The Subject starts with a \hyperref[ch:mutation]{mutation} and 3 corruption.}{6}
\boon{Mutation Prone}{The Subject gains a Mutation every 7 corruption (rather than 10).}{6}
\boon{Mutation Resistant}{The Subject gains a Mutation every 14 corruption (rather than 10).}{3}
\begin{exampleblock}
	Any one Subject cannot be both \emph{Mutation Prone} and \emph{Mutation Resistant}, obviously.
\end{exampleblock}
\end{multicols}

\section{Banes}
\bane{Mark of Sacrifice}
	{The Subject bears the mark of sacrifice somewhere on his body.
	...
	{}
\bane{Voidscarred}
	{Otherworldly entities are aware of the Subject.
...
\ability{Steeled}
	{400}
	{Courage 40}
	{Whenever the Subject would gain corruption,
...
\luaimport{components/bestiary.json}{beast.tpl}{components/horrorbestiary}
