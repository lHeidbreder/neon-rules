...
\vspace{8mm}
\begin{multicols}{2}
\boon{Blessed Birth}{The character starts with a \hyperref[ch:mutation]{mutation} and 3 corruption.}{6}
...
\begin{exampleblock}
	A character cannot be both \emph{Mutation Prone} and \emph{Mutation Resistant}, obviously.
\end{exampleblock}
\end{multicols}
