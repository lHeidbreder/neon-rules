...
\begin{document}
	...
	\begin{exampleblock}
		\itshape
		This module adds supernatural threats,
		inspired by the likes of
			Lovecraft's mythos,
			SCP,
			Rimworld: Anomaly,
			and 40k's Warp.
		If you are looking for an experience like that,
		you have come to the right place.
		\par%
		Be aware that this addon is pretty expansive.
		If you decide to add it to the table,
		note that it will likely become a major part of the game.
	\end{exampleblock}
	\begin{center}
		\filltopageendgraphics{../art/\subtitle/intro-filler.png}
	\end{center}
	...
	Then, in some cases, mortal creatures can be elevated or corrupted into \emph{Mutants}.
	
	\section{Insight}
	\subsection{Gaining Insight}
	Subjects gain Insight whenever they perceive horrors from beyond with any sense they were given naturally
		- i.e. hearing, seeing, smelling, tasting or touching.
	The feeling is generally unpleasant.
	\\
	Perceiving any creature with the DEMONIC trait will cause D5 Insight.
	Particularly powerful beings or groups may cause D10.
	\subsection{Reducing Insight}
	Subjects may reduce their Insight by resting,
		secluded from such anomalies.
	It then reduces by 6 every day.
	\subsection{Effects of Insight}
	Every point of Insight reduces a Subject's Courage by 1.
	When Courage reaches 0 due to Insight,
		the Subject goes catatonic for at least a week and gains D10 corruption.
	...
	\begin{sitemize}[8]
		\item In areas with a lot of such presence, Subjects gain up to 1 corruption per hour.
	...
	A Subject can accrue up to 100 corruption, at which point he will transform
	...
	\chapter{Mutation}
	\label{ch:mutation}
	\vspace{-20mm}%quick fix
	Every now and then a Subject may be forced to mutate.
	Roll a D100, divide by 2 and consult the table below.
	The result may be modified by a tenth of the blessed's insight at the time of mutation.
	\begin{exampleblock}
	...
	\begin{multicols}{2}
		\begin{enumerate}
			...
			\luaimport{components/mutations.json}{mutation-tableentry.tpl}{muttable}
		\end{enumerate}
	\end{multicols}
	...
	\begin{multicols}{2}
		...
		\luaimport{components/mutations.json}{mutation.tpl}{mutations}
	\end{multicols}
	...
	\\
	For many requests the leader needs a very firm understanding of the infinite void and its inhabitants. 
	...
	\end{sitemize}
	\section{The Ritual}
	When preparation is done, the ritual then takes a few hours and an Occultism test.
	The test may be modified by
	\begin{sitemize}
		\item the tribute
		\item the request
	\end{sitemize}
	\vspace{-8mm}
	The test does not suffer from the reduction in Cr from Insight.
	\par
	...
	\section{The Outcome}
	A "successful" ritual does not necessarily mean the desired outcome.
	Instead the Adjudicator secretly rolls a D5 and consults the table below.\\
	For every 3 full DoS the ritual succeeded with, one option may be excluded by the leader.
	If an excluded option is rolled, the leader may freely choose the outcome instead.
	\par
	\vspace{-5mm}
	\begin{enumerate}
		\raggedright
		...
		The leader may have a higher chance to be chosen.
	\end{enumerate}
	\section{The Reward}
	...
	By the Adjudicator's discretion some casters may use this new, while some may use the old way of casting.
