...
\begin{document}
	...
	To buy materials, the character collects a point pool equal to 10\% of an object’s cr cost through \emph{Commerce} checks.
...
%		Chemicals & 3 * duration in hours & price (per dosage) \\ %TODO: add after chemical rework
	...
	Failing critically causes loss of all material in as spectacular a fashion as befitting of the character, tools and whatever materials were lost.
\end{document}