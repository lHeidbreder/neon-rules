...
\label{ch:act1}
\vspace{-20mm} %fixes bottom of page
The Crew, currently doing R\&R in a safe location,
...
\begin{sitemize}
	\item She claims to work for Hyperion Global Networks.
	\item An early AI chip prototype was stolen from Hyperion Global Networks.
	\item She knows who has it (\hyperref[char:hayes]{Dr Alden Hayes}).
	\item She knows of a data broker, \hyperref[char:rika]{Rika},
		who most likely has the doctor's location.
		You can find her on the \hyperref[location:techbazaar]{Tech Bazaar}.
	\item Retrieve it for her.
	\item She is willing to pay cR 600 each.
		\\%
		If the Crew demands prepayment,
		she's willing to give each up to cR 150 in advance,
		as she knows she's being followed.
	\item It'll likely be moved within the next few (meaning 2 or 3) days.
		They'll need to hurry.
	\item She explains how to contact her securely,
		but demands the Crew don't contact her again until the job is done.
\end{sitemize}
\vspace{-5mm}
There is more information,
	which she will not share willingly.
Smart or educated Protagonists may figure out some of the below:
\begin{sitemize}
	...
	\item She is on Hyperion Global Networks' wanted list.
	\item Working with her will get the Crew on the same list.
\end{sitemize}

\vspace{-5mm}
If the Protagonists take too long,
	a group of mercenaries working for Hyperion Global Networks,
	looking for Dusk,
