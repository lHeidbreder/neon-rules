...
if __name__ == '__main__':
    ...
    for key, tbl in extracted_tables.items():
        with open(out_filepath_prefix + "-" + key + ".jsonin", mode="w", newline="", encoding="utf-8") as outfile:
            content = json.dumps(tbl)
