...
\begin{document}
	...
	Cybercraft, being their nature, becomes a basic skill.
	...
	\begin{sitemize}[8]
		...
		\item An AI does not earn money.
			...
			\textit{If, for example, a group of 4 player characters would be paid cR 150 each, 3 player characters carrying an AI should receive cR 200 each and be expected to buy any necessary equipment for their AI companion.}
	...
	\begin{center}
		\begin{tabularx}{0.7\textwidth}{X|rr}
			Race & Cost & Page \\
			\hline%
			\luaimport{ai-races.csv}{race-sum.tpl}{airaces-summary}
		\end{tabularx}
	\end{center}
