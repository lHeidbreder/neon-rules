...
\def\subtitle{AI}
\renewcommand{\titletextcolor}{Blue}
\renewcommand{\titleshadowcolor}{SkyBlue}
...
\begin{document}
	...
	Wirewalk, being their nature, becomes a basic skill.
	...
	\begin{sitemize}[8]
		...
		\item An AI does not earn money.
			...
			\begin{exampleblock}
				\itshape
				If, for example,
				a group of 4 Protagonists
				would be paid cR 150 each,
				3 human Subjects and an AI
				should receive cR 200 each
				and be expected to buy any necessary equipment for their AI companion.
			\end{exampleblock}
	    \item While an AI is "just data",
            making a backup or a clone is impossible,
            as its personality depends on volatile state.
            \\%
            This also means turning off a device completely will destroy any strong AI it houses.
	\end{sitemize}
	...
	In many cases the 20 questions in the core rules may not be applicable to AI Subjects.
	Below they are readjusted to better fit what would be interesting for them.
	\begin{multicols}{2}
	\begin{enumerate}
		\setlength\itemsep{-6mm}
		\item What represents you visually?\\
		...
		\item What first impression do you leave on strangers?\\
		...
		\item Why did you join the Crew?\\
		\textit{What event caused you to give up your previous existence? What are you after; what is it that drives you? Is another Protagonist perhaps your creator or main user?}
		...
		\item What does your morality look like and how law-abiding are you?\\
		...
		\item Are you open towards strangers?\\
		...
		\item What types of data do you prioritize, prefer or find most useful?\\
		...
		\item What character traits define you?\\
	...
	\begin{center}
		\begin{tabularx}{0.7\textwidth}{X|rr}
			Anthrotype & Cost & Page \\
			\hline%
			\luaimport{ai-races.json}{race-sum.tpl}{airaces-summary}
		\end{tabularx}
	\end{center}
	\subsection*{In detail}
	\luaimport{ai-races.json}{race.tpl}{airaces}
