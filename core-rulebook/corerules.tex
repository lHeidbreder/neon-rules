...
%	\textbf{Body purists} believe that too many augments makes a human lose his humanity. Others fear that nerve load might be higher than initially expected, crippling some, driving others insane. The reliance on technology makes humans vulnerable to failure of even just one of those systems. Body purism is no monolith; supporters might believe one or multiple of these things or even something else entirely.
	...
	*TODO: add ref*
	...
	\ability{Volume of Fire}{350}{*TODO*}{When using a weapon with a rate of fire above 1 to take a standard shot, the character may spend more ammunition to gain a +5 to hit per shot fired after the first, up to the weapon's rate of fire.}
	...
	\ability{Where it hurts}{400}{Hand-to-hand Basics, Strength 40}{The character's unarmed attacks gain the Tearing special rule.}
