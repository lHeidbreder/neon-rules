...
\begin{document}
	...
	Any test may benefit from multiple applicable educations,
		but the skill bonus may at most be doubled.
	\par%
	...
	\end{exampleblock}
%TODO: education can only double the skill's bonus.
	An Education has three potential levels.
	They have to be acquired in order.
	\begin{sitemize}
		\item \textbf{Familiar} (200 XP, granting +10)
		\item \textbf{Informed} (500 XP, granting +10)
		\item \textbf{Knowledgeable} (800 XP, granting +10)
	\end{sitemize}
	...
	\begin{exampleblock}
		...
		She her \emph{Estimate} is \emph{Known}.
