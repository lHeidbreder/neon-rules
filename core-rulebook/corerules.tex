...
%	Starvation starts recovering when the character has eaten enough again by one step every rest phase.
	...
	\paragraph{Nuclear} hazards are essentially a radiological hazard following an explosive and should therefore be handled as an explosive, an EMP and a radiological hazard.
