...
%		This serves as the foundation for proper combat training.
	...
	%TODO: steal imperium maledictum's crit rules
...
%	Starvation starts recovering when the character has eaten enough again by one step every rest phase.
	...
	After about an hour or two of exposure the afflicted makes a constitution check at a penalty or suffers ill effects depending on the dosage of radiation. Decrease the severity by one step per degree of success on the resistance test.
	%TODO: list ill effects
