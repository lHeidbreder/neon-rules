...
\skill[Advanced]{Wirewalk}{Intelligence}{Wirewalk means using a computer. That technically includes even the simplest tasks but only advanced operations will require a test, such as getting access to files that one should not have access to.}
