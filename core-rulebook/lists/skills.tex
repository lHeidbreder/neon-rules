...
\skill[Advanced]{Cybercraft}{Intelligence}{Cybercraft means using a computer. That technically includes even the simplest tasks but only advanced operations will require a test, such as getting access to files that one should not have access to.}
...
\ranged{Integrated Weaponry}{Ranged weapons resulting from implants or modded armor. Instead of trigger these are fired using L1NC.}
