...
one Education +2, two Educations +1\\
...
\end{tabular}\par
\noindent\textbf{Other modifiers:} \\
\textbf{Skills:} Computer Operation +1, %TODO: need 200
Construction +3,
Estimate +1,
Mechanics +2\\
\textbf{Abilities:} \\
...
\end{tabular}\par
\noindent\textbf{Other modifiers:} \\
\textbf{Skills:} Melee Combat Training (Short Blades) +1,%TODO: name properly
Appeal +2,
Deceive +1,
Interrogation +1,
Quaffing +1,
...
\hrulefill
\paragraph*{Hacker - White Hat (3 GP)}
...
\end{tabular}\par
\noindent\textbf{Other modifiers:} \\
\textbf{Skills:} Ranged Combat Training (Pistol) +1,
Interrogation +2,
Perception +2,
Law +2,
Security +2\\
...
\end{tabular}\par
\noindent\textbf{Other modifiers:} \\
\textbf{Skills:} Commerce +1, Dodge +1, Mechanics +2, Medication +1, Melee Combat Training (any one) +2, Perception +1\\
\textbf{Abilities:} \\
\textbf{Boons:} \\
\textbf{Banes:} \\
...
\end{tabular}\par
\noindent\textbf{Other modifiers:} \\
\textbf{Skills:} Melee Combat Training (One armed) +2,
...
\end{tabular}\par
\noindent\textbf{Other modifiers:} \\
\textbf{Skills:} Ranged Combat Training (Pistol) or Melee Combat Training (Short Blade) +1,
Appeal +1,
Commerce +2,
Deceive +2,
Intimidation +1,
