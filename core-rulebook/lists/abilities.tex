%TODO: fix naming
%some names are "Word Word, but some are "Word word", the former is requested
	\section{Abilities}
\label{abilitylist}
\vspace{3mm}
\begin{multicols}{2}
...
\ability{Natural Geek}{350}{Intelligence 45}{Halves penalties to thinking tasks from not knowing what you're doing. This may include Weapon Training and Skills but does not include any stressful or reactionary tasks or purely physical actions (like Stealth, Athletics or Perception).}
...
\ability{Perfectionist Craftsman}{400}{Experienced in a crafting skill}{Doubles the degrees of success on crafting tests when the specific skill meets the requirements.}
...
\ability{Rapid Reload}{300}{Dexterity 40}{When reducing reload time to below 1 action, reload as a free action.}
...
\ability{Ripper}{350}{Render}{When dealing damage with the Tearing rule and rolling doubles, you may choose those two dice.}
...
\ability{Unbreakable Bond}{250}{being good friends; if one is Clumsy and the other is Cursed by Fortuna, the cost is only 100 XP}{When around a specified close friend, that friend may make a +20 charisma check as a free action and every degree of success gives the character +10 to resist fear and pinning. If both of them have Unbreakable Bond, the bonus to the charisma check is +40 instead.}
