%TODO: \luaimport{lists/abilities.csv}{}{lists/abilities}
	\section{Abilities}
\label{abilitylist}
\vspace{3mm}
\begin{multicols}{2}
...
\ability{Augsmith}{350}{Mechanics Experienced, Bio-Maintenance Experienced}{The character is capable of repairing cybernetic implants.}
\ability{Bar Fighter}{250}{Quaffing Trained}{Ignore \emph{Improvised} penalties.}
\ability{Battle Mind}{400}{Intelligence 40}{The character may add a tenth of his Intelligence to \emph{Base Initiative}.}
\ability{Battle Sense}{500}{Perception Trained}{Adds a fifth of Perception Bonus (2, 4, or 8) to initiative.
	Doubles penalties to attacks of opportunity against the character.}
\ability{Beta Strike}{500}{Constitution 40, no Alpha Strike}{The user gains +10 to hit any character that has already attacked him during this combat encounter.}
...
\ability{Focused Frenzy}{350}{Instinct 30, Intelligence 40, no Unbridled Rage}{
	When the character is made to go berserk by some means, they can still identify friend and foe.
	When no foes are left and the \emph{Frenzy} does not end, friends still become valid targets.}
...
\ability{Hax0r e1337}{400}{Wirewalk Experienced}{Add two degrees of success to any Wirewalk tests to crack other devices or protect your own.}
...
\ability{Medical Insight}{400}{Bio-Maintenance Experienced}{Doubles the degrees of success on Bio-Maintenance tests to help others recover.}
...
\ability{Natural Geek}{350}{Intelligence 45}{The character can add their Education's full bonus, regardless of it surpassing the Skill's bonus.}
...
\ability{Overly Cautious}{300}{Instinct 30}{The character becomes jittery or nervous,
	but when attacked he can ignore Unaware conditions by passing a Routine Perception check,
...
\ability{Provoke}{350}{Courage 45}{
	Spend an action to taunt an enemy
	and make a fitting skill test opposed by the target's \emph{Restraint}.
	If the character wins,
	the target must attack the character at the next opportunity.}
...
\ability{Stabilization}{300}{Bio-Maintenance Trained}{The character is able to staunch light bleeding on others in one round without equipment.}
...
\ability{Thick Skull}{400}{Constitution 50}{Grants immunity to the Trauma special rule and resisting the \emph{Stun} special rule gains +10.}
