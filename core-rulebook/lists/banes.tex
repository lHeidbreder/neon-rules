%TODO: \luaimport{lists/banes.csv}{}{lists/banes}
\section{Banes}
\label{sec:banelist}
\vspace{4mm}
\begin{multicols}{2}
...
\bane{Bathophobia (DC)}{The character is afraid of depths. This may trigger at the bottom of the ocean just as much as it could in a massive canyon.}{1}{per 10}
...
\bane{Claustrophobia (DC)}{The character is afraid of small, narrow places.}{3}{per 10}
...
\bane{Directionally Challenged}{The character has extreme difficulty distinguishing left from right. This makes navigation quite difficult: navigation and navigation-related tests - like tests made in a chase - are at a -10 and can never benefit from map data (like Roadware).}{5}{}
...
\bane{Forgetful}{The character tends to forget even the most important details.
	Any Education is twice as expensive.}{12}{}
...
\end{exampleblock}
\bane{Slave Mentality (DC)}{
	The character does not like making his own decisions
	- such situations put a lot of stress on the character.
	He is instead likely to adopt an idea ushered by someone else.
}{1}{per 5}
...
\bane{Superstition (DC)}{The character is superstitious, often believing ideas that depend on far fetched assumptions.}{1}{per 5}
