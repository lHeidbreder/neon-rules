...
\begin{tabularx}{0.5\textwidth}{ll}
	Head & -20 to Instinct and Charisma
	\\
	Arms & -20 to Dex and Combat rolls
	\\
	Legs & -20 to Agility, -2 MS
	\\
\end{tabularx}
}
...
\index{Armor!Reuse}
When a Subject acquires one or more pieces of armor from fallen combatants,
...
The Subject simply won't fit
- it's scrap at best.
\\%
If the Subjects are of different Sizes (see p. \pageref{sizestable}),
...
the Adjudicator may obviously forego the roll.

\paragraph{PES have to be calibrated.}
\index{PES!Calibration}
