...
\section{Ranged}
\subsection{Weapons}
%TODO: possibly putting weapons in samepage rather than minipage can fix the text passing the page number
\rangesec{Pistol}
\rangesec{Short Rifle}
%TODO: first long rifle passes the bottom of the page
\rangesec{Long Rifle}
\rangesec{Heavy}
\rangesec{Launcher}
\rangesec{Bow}
