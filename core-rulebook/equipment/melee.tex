...
\meleecomponent{Short Shaft}
    ...
    {One-handed; +10 to attacks, -10 to defense}
    {0,3}
    {4}
    {}
    {}
\meleecomponent{Long Shaft}
    ...
    {Two-handed; +10 to attacks, -10 to defense}
    {0,5}
    {5}
    {}
    {}
\meleecomponent{Twin Shaft}
    ...
    {Two-handed; allows to add a second weapon point}
    {0,5}
    {11}
    {}
    {}
\meleecomponent{Rifle}
    ...
    {Two-handed; -5 to both melee combat rolls and aim actions with the rifle}
    {-}
    {-/-}
    {}
    {}
