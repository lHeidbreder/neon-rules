...
\begin{multicols}{2}
\supply{AI Docking Station}{By itself this device does nothing but it has the requirements to hold an AI.\\
	Integrity: 15\\
	Firewall: 6\\
...
\supply{Weapon Sling}{Holds a larger weapon.}{cr 5}{0,4 kg}
\end{multicols}
...
\supply{Lighter}{A lighter with a flip-off top that is able to produce flame. Has enough fuel for 100 uses}{cr 1}{0,1 kg}
