...
\supply{Flash Glass Goggles}
    ...
    {42}
    {0,45}
\supply{Holographic Eyepiece}
    {Allows a HUD to be displayed over one eye.}
    {28}
    {0,3}
...
\supply{Rape Whistle}
    ...
    {0,05}
\supply{Riot Shield}
%TODO: improvised melee weapon with Protective
...
\supply{Blowtorch}
    {A blowtorch that can be used in any atmosphere and underwater.
        ...
        given enough time.\\
        For every 2 points of armor or cover something gives, %TODO: rephrase
