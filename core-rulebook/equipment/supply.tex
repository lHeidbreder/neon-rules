...
\vspace{10mm}
\begin{multicols}{2}
    \supply{AI Docking Station}{By itself this device does nothing but it fulfills the requirements to hold AI.\\
	Integrity: 15\\
	Firewall: 6\\
...
\supply{Roadware}{Weak AI based GPS-reading software that assists drivers at high speeds and off-roads. The unit gives a +20 Bonus to high-speed driving Tests and Stunting Tests.}{cr 14}{4,8 kg}
\end{multicols}
