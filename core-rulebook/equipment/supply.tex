...
\supply{Climbing Kit}
    ...
    {5}
\supply{Earplugs}
    {A set of top-grade earplugs that allow Subjects
...
\supply{Stitch Kit}
    {A more elaborate needle and thread that will close wounds for good.
        ...
        Generally cannot be applied by the bleeding Subject on his own.}
    {22}
    {0,6}
    {4}
...
\supply{Wound Dressing}
    {
        ...
        Cannot easily be applied by the bleeding Subject on his own.
...
\supply{Handcuffs}
    {Used to bind an individual’s hands or ankles.
        To escape, said individual must roll a -40 Sleight of Hand test or a -60 Strength test.
...
\supply{Rape Whistle}
    ...
    {4}
\supply{Riot Shield}
    {The Anti-Ballistics Riot Shield acts as mobile cover.
...
\supply{Bolt Cutters}
    {Powerful bolt cutters.
        ...
        Pincers may need to be replaced after heavy duty, as determined by the Adjudicator.}
    {12}
    {1,1}
    {5}
\supply{Crowbar}
