...
\vspace{10mm}
\begin{multicols}{2}
    \supply{AI Docking Station}{By itself this device does nothing, but it fulfills the requirements to hold even strong AI.\\
	Integrity: 15\\
	Firewall: 6\\
...
\supply{Night Vision Goggles}{Grants Boon: Night Vision but doubles all penalties to resist being blinded by bright light.}{cr 18}{0,6 kg}
...
\vspace{10mm}
\begin{multicols}{2}
\supply{Parachute}{Standard issue parachute. Maneuvering uses Pilot: Air but anyone can decent moderately safely using this.}{cr 10}{9,5 kg}
\supply{CBRN Unit}{This unit detects and gives information on chemical and radioactive materials, or any other airborne or grounded contaminant. It will get overworked after 60 minutes in strong radiation, thick gases or similar effects and will need to be recalibrated to continue to offer precise results.}{cr 12}{0,9 kg}
\supply{Climbing Kit}{A climbing harness kit that offers the character a +40 Bonus to climbing tests.}{cr 7}{2,2 kg} %TODO: weight?
...
\supply{Flotation Vest}{An adjustable flotation vest that allows up to 210 kg to float in water.}{cr 2}{1 kg}
\supply{Gas Mask}{Allows to breathe in toxic environments. Comes with 5 filters.}{cr 18}{1,1 kg}
...
\supply{Handcuffs}{Used to bind an individual’s hands or ankles. To escape, a character must roll a -40 Sleight of Hand test or a -60 Strength test. The handcuffs have an armor rating of 10 and 50 break points.}{cr 12}{0,5 kg}
...
\supply{Riot Shield}{The Anti-Ballistics Riot Shield acts as mobile cover for a character. 	It is made of heavy mineral carbon with a hardened plastic window to see through. \\
...
\vspace{10mm}
\begin{multicols}{2}
\supply{Area Heater}{A small heater that can heat an area powerful enough to fill a dome tent.}{cr 24}{2,3 kg}
...
\supply{Blowtorch}{A blowtorch that can be used in any atmosphere and underwater. This blowtorch is plasma based and will sear through any metal, given enough time.\\
	For every 2 points of armor or cover something gives, it takes 1 action to cut through a small portion of it}{cr 18}{1,8 kg}
...
\supply{Grappling Hook}{A metal rod with hooks on them that allow for easier climbing when attached to a rope. Grants +10 to Climbing tests.}{cr 4}{1 kg}
\supply{Gun Swivel}{A swivel arm that holds the gun. It reduces recoil but is rather cumbersome; it halves top movement speed and the \emph{Burst} penalty. It is not an exoskeleton and does not allow the use of much heavier guns.}{cr 42}{1,4kg}
...
\supply{Chemical Light Sticks}{A chemical light stick is a bendable tube, that when bent, begins to glow. Gives a +10 in any dark scenarios. Lasts for 8 hours. Comes in packs of 10.}{cr 2}{0,2 kg}
