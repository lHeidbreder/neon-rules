...
\begin{multicols}{2}
\armor{Biker helmet}{3}{0}{0}{0}{head}{2 mods; -5 to sight-based perception, +5 to Drive(Bike) checks}{16}{1.5}
\armor{Armored suit}{0}{4}{2}{3}{torso, arms, legs}{1 mod; Inconspicuous}{59}{2}
\armor{Tough coat}{0}{2}{1}{1}{torso, arms}{0 mods; Inconspicuous}{25}{2}
\armor{Flak jacket}{0}{5}{5}{1}{torso, arms}{1 mod; Inconspicuous}{36}{2}
\armor{Tough pants}{0}{0}{0}{2}{legs}{0 mods; Inconspicuous}{18}{1.5}
\end{multicols}

\subsection{Helmets}
A section on protective head wear, armoring the arguably most vulnerable body location.\par
\begin{multicols}{2}
\armor{Blast helmet}{14}{0}{0}{0}{head}{1 mod; -10 to sight-based perception, immune to Trauma}{123}{8}
\armor{Improvised helmet}{5}{0}{0}{0}{head}{1 mod; -5 Ag, Improvised}{24}{3}
\armor{Banshee helmet}{6}{1}{0}{0}{head}{2 mods; inbuilt spotter target assist system}{111}{2}
\armor{Flak helmet}{8}{0}{0}{0}{head}{1 mod; -5 to sight-based perception}{50}{1.5}
\armor{Ghost helmet}{6}{0}{0}{0}{head}{2 mods; projects a holographic image onto the helmet, granting +10 to intimidation when active and visible to the opponent}{53}{5}
\armor{EVA helmet}{5}{0}{0}{0}{head}{3 mods; vac-sealed}{44}{2}
\armor{Argus helmet}{10}{0}{0}{0}{head}{2 mods; -10 to sight-based perception, inbuilt explosives detection assistant}{118}{9}
\end{multicols}

\subsection{Body Armor}
Armor pieces below are about protecting the largest location of the human body.\par
\begin{multicols}{2}
\armor{EOD armor}{3}{20}{18}{2}{torso, arms}{2 mods; -2 movement speed, -10 Ag, -10 to Dex and shooting tests}{370}{36}
\armor{Banshee suit}{0}{10}{7}{0}{torso, arms}{2 mods; inbuilt climbing gear}{349}{4}
\armor{Improvised vest}{0}{9}{0}{0}{torso}{1 mod; -5 Ag, Improvised}{25}{3.5}
\armor{Stab vest}{0}{9}{0}{0}{torso}{1 mod; -5 Ag, immune to piercing rule}{49}{3.5}
\armor{Flak vest}{0}{12}{0}{0}{torso}{1 mod; -5 Ag}{105}{4}
\armor{UA pauldrons}{0}{0}{10}{0}{arms}{2 mods; -5 Ag}{88}{3.5}
\armor{Ghost suit}{0}{10}{7}{0}{torso, arms}{3 mods; does not stop a skin-tight holoprojector, includes piezoelectric exo-frame}{329}{12}
\armor{Locust armor}{0}{8}{0}{2}{torso}{2 mods; includes jump pack}{272}{38}
\armor{Node armor}{0}{14}{4}{0}{torso, arms}{3 mods; can carry AI\\
	includes piezoelectric exo-frame}{358}{14}
\armor{EVA suit}{0}{3}{3}{3}{torso, arms, legs}{4 mods; vac-sealed}{29}{2.5}
\armor{Shadow suit}{0}{3}{3}{3}{torso, arms, legs}{0 mods; the wearer gains +20 to hide and is at a -10 to hit in low-light and darkness}{112}{2.8}
\end{multicols}

\subsection{Leg Armor}
This section is the result of a fine balance act between all-important movement and protection.\par
\begin{multicols}{2}
\armor{Blast greaves}{0}{1}{0}{18}{legs}{1 mod; -1 movement speed, -10 Ag}{96}{10}
\armor{Banshee greaves}{0}{0}{0}{6}{legs}{2 mods}{83}{2}
\armor{Flak greaves}{0}{0}{0}{10}{legs}{2 mods; -5 Ag}{38}{2.5}
\armor{Ghost greaves}{0}{0}{0}{6}{legs}{1 mod; halves penalties from noise on sneaking}{103}{6}
\armor{Locust greaves}{0}{0}{0}{6}{legs}{2 mods; reduces fall damage to a quarter}{128}{5.5}
\end{multicols}
...
\armormod{Auto-Loader}{
	A reload assistance system added to the outer thighs
	which halves reload times
	for magazine-fed pistols (without the \emph{Single Loader} rule).
	When present on both legs,
	this will allow reloading both guns while dual wielding.
}{cR 14}{1}{N}{1.2 kg}
...
\armormod{Discardable Plate}{
	Adds an outer layer that can be discarded easily.
	Useful when on fire or drenched in acid.
	\\%
	When hit by a weapon with \emph{Rending},
	the plate is destroyed,
	but the armor is unharmed.
}{cR 12}{1}{N}{1.4 kg}
...
\armormod{Final Hour Chip}{Once the wearer's vital signs cease,
	the armor self-destructs violently,
	dealing damage like a 40mm thermite grenade,
	except with a 6m Blast radius instead.
	Requires a vital monitor.}{cR 170}{0}{Y}{0.1 kg}
...
\armormod{Flashlight}{Adds a flashlight and its related bonuses,
	without the need to use your hands.
	Hitting the location the active flashlight is attached to is at no penalty for low light or location.
	}{cR 65}{1}{N}{1.1 kg}
...
\armormod{HUD}{Adds a heads up display to the helmet visor.
	Can be wired to display basically any device,
	but does not come with input peripherals.}{cR 4}{1}{N}{0.8 kg}
...
\armormod{Jump Pack}{A backpack-like armor attachment containing boosters to increase jump height, leap length, allow some amount of control in the air or stop hitting the floor at a violently rapid pace.
	Requires Pilot (Jetpack) to steer.\\
...
\armormod{Nanomesh Undersuit}{The minimum armor the wearer can be reduced to (by e.g. maneuvers) is 8 in any location that is covered by the modded piece of armor.}{cR 43}{0}{N}{2.3 kg}
\armormod{Night Vision}{A night vision device included in the helmet.}{cR 14}{1}{N}{0.7 kg}
\armormod{Odysseus Nav System}{A display that includes many forms of navigation systems, granting a +10 to driving and +20 to navigation tests.}{cR 28}{1}{N}{1.3 kg}
\armormod{Oversized Mag Holster}{Hooks to hold a taped or drum mag}{cR 16}{1}{N}{0.2 kg}
\armormod{Photo-Reactive Panels}{
	While powered, the armor will automatically match the surroundings.
	This grants the same benefits as the \emph{Ghillie} armor mod.
}{cR 55}{0}{Y}{0.8 kg}
...
%TODO: basically exists as implant already
...
\armormod{Temperature Regulators}{Tries to keep the armor's internals at around room temperature,
		preventing heat stroke and hypothermia in all but the harsh wastelands.
	}{cR 24}{1}{N}{0.8 kg}
\armormod{TROPHY ADS}
