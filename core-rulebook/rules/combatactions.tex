...
Unless restrained, a prone Subject can spend one action to start kneeling,
	a kneeling Subject can spend an action to \emph{stand up}.
A prone Subject may also choose to make an agility check instead to \emph{hop up},
	i.e. stand up fully in one action.
On a success he stands up, on a fail he stays prone.
The test is modified based on balance modifiers, like slants, liquid or rubble.
\\%
Dropping lower always is a free action, no matter if to the knees or prone.
\subsection*{Jump to Cover}
When declaring actions for the combat round a Subject may choose to jump into cover.
...
The combatant gets a grip of the battlefield again, usually after losing her overview.
\\%
She spends an action to re-roll initiative.
\subsection*{Tactics}
The combatant quickly shouts out some instructions to assure coordination.
She makes a Logic test and may freely distribute her DoS between her allies to grant them additional initiative.
This modifier is maintained when they perform Gather Senses actions.\\
Any one Subject may gain up to 6 points of additional initiative from this action.
Some Subjects, like those in panic, may be excluded as per Adjudicator's discretion.
\\%
...
As an action the combatant may make a Restraint test.
This test is at a penalty equal to the penalty he wants to suppress.
If the test succeeds,
	the Subject may ignore said penalties for the combat encounter or scene,
