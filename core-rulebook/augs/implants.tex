...
Its DoS and those of Bio-Maintenance tests to improve regeneration cannot be allocated to said replacements.
\\%
...
\implant{L1NC}
	...
	Most important information is shared through it:
	Shopping windows,
		guides,
		traffic signs,
		to name a few.
	People without this implant essentially live in another world, and are generally suspicious within the city.
	\\%
	Due to its importance, the L1NC has been optimized to the extreme.
	It is the safest implant out there, having almost no load on the body.
	It is also shielded from EMP.
	}
	{-}
	{-}
	{45}
...
\implant{Lifter Arms}
    ...
    {Str for the purpose of determining carry weight, and on tests for slow feats of strength is increased by 40.}
    {arms, chest}
    {3 RI}
    {170}
