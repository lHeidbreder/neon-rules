...
\\%
Find Cybernetic implants in \ref{implants-Cybernetic} (p. \pageref{implants-Cybernetic}).
...
\\%
Find Biotech implants in \ref{implants-Biotech} (p. \pageref{implants-Biotech}).
\section{Chemicals}
...
\\%
Find Chems in \ref{sec:chems} (p. \pageref{sec:chems}).
