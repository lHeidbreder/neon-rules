...
%Ammo macros
\newcommand{\arsenalhotcoldammo}{Identifying the shooter's position by hearing gains}
\newcommand{\arsenaltracerammo}{Others shooting the same target this turn gain +10 to hit.}
\newcommand{\arsenaligniteammo}{Flammable materials will ignite on hit}
\newcommand{\arsenalrubberammo}{Every hit against the target's head reduces its initiative by}
